...
/*      displacementMap.wrapS = THREE.RepeatWrapping;
    ...
    updateScreenSize() {
        ...
        let up_w = this.container.scrollWidth;
        let up_h = this.container.scrollHeight;
    ...
    animate = () => {
        ...
        // let mixerUpdateDelta = this.delta;
        // if (this.characterControls) {
        ...
        if (this.userCharacterControls) {
           ...
           // this.userPosition(this.userCharacterControls.controls.target)
             //console.log(this.controls.target)
             //this.socket.emit('CameraTarget', this.controls.target.x, this.controls.target.y)
         }
