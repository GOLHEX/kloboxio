...
import NURBSCurve from "./examples/js/curves/NURBSCurve";
import TGALoader from "./TGALoader";

import Zlib from "./examples/js/libs/inflate.min";
import * as fflate from "./controls/three.js-r141/examples/jsm/libs/fflate.module.js";
	...
	class FBXTreeParser {
		...
		loadTexture( textureNode, images ) {
			...
			if ( extension === 'tga' ) {
				...
				const loader = new TGALoader(this.manager);
