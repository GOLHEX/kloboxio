...
class BasicCharacterController extends Component{
    ...
    if (!this._stateMachine._currentState) {
      return;
		...
		oldPosition.copy(controlObject.position);
		this._position = controlObject.position;
...
class ThirdPersonCameraDemo extends Component{
  constructor(props) {
	super(props);
	...
	animate = () => {
		...
		this.timerS = this.timeElapsed * 0.001;
...
/*		if(this.mixer)(
		...
		//this._thirdPersonCamera.Update(this.delta);
...
export default ThirdPersonCameraDemo;
